...
const Car2 = () => {
  return (
    ...
    <AnimatePresence mode='wait'>
      <motion.div className='flex justify-center items-center gap-x-20 pt-20'>
      ...
      <Image className='z-10' src={require('../images/redLambo.png')} width={900} height={900} alt='Lambo' />
      <ParticlesContainer  />
