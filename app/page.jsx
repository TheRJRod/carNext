...
export default function Home() {
  return (
      ...
      <motion.div className='flex justify-center gap-x-32 pt-32 items-center '>
    ...
    <Link href='/car1details'><button className="border border-white text-white rounded-full py-2 px-4 text-xl self-start hover:bg-yellow-500">View latest model</button></Link>
      ...
      <Image className='z-10' src={require('./images/bugatti.png')} width={800} height={800} alt='bugatti' />
      <ParticlesContainer/>
