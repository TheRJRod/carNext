...
const Car3 = () => {
  return (
    ...
    <AnimatePresence mode='wait'>
      <motion.div className='flex justify-center gap-x-32 pt-24 items-center pl-32'>
      ...
      <Image className='z-10' src={require('../images/bmw2.png')} width={900} height={900} alt='BMW' />
      <ParticlesContainer />
